...
export const NIGERIA_LOCATIONS = [
    { state: 'Abia', lgas: ['Aba North', 'Aba South', 'Umuahia North', 'Umuahia South', 'Other'] },
    { state: 'Adamawa', lgas: ['Yola North', 'Yola South', 'Mubi', 'Other'] },
    ...
    { state: 'Anambra', lgas: ['Awka', 'Onitsha', 'Other'] },
    { state: 'Bauchi', lgas: ['Bauchi', 'Other'] },
    { state: 'Bayelsa', lgas: ['Yenagoa', 'Other'] },
    { state: 'Benue', lgas: ['Makurdi', 'Other'] },
    { state: 'Borno', lgas: ['Maiduguri', 'Other'] },
    { state: 'Cross River', lgas: ['Calabar', 'Ogoja', 'Other'] },
    { state: 'Delta', lgas: ['Warri', 'Asaba', 'Ughelli', 'Other'] },
    { state: 'Ebonyi', lgas: ['Abakaliki', 'Other'] },
    { state: 'Edo', lgas: ['Benin City', 'Other'] },
    { state: 'Ekiti', lgas: ['Ado Ekiti', 'Other'] },
    { state: 'Enugu', lgas: ['Enugu North', 'Enugu South', 'Nsukka', 'Other'] },
    { state: 'FCT', lgas: ['Abuja Municipal', 'Bwari', 'Gwagwalada', 'Kuje', 'Kwali', 'Abaji'] },
    { state: 'Gombe', lgas: ['Gombe', 'Other'] },
    { state: 'Imo', lgas: ['Owerri', 'Orlu', 'Other'] },
    { state: 'Jigawa', lgas: ['Dutse', 'Other'] },
    { state: 'Kaduna', lgas: ['Kaduna North', 'Kaduna South', 'Zaria', 'Other'] },
    { state: 'Kano', lgas: ['Kano Municipal', 'Other'] },
    { state: 'Katsina', lgas: ['Katsina', 'Other'] },
    { state: 'Kebbi', lgas: ['Birnin Kebbi', 'Other'] },
    { state: 'Kogi', lgas: ['Lokoja', 'Other'] },
    { state: 'Kwara', lgas: ['Ilorin', 'Other'] },
    { state: 'Lagos', lgas: ['Agege', 'Alimosho', 'Apapa', 'Epe', 'Eti Osa', 'Ibeju-Lekki', 'Ikeja', 'Ikorodu', 'Lagos Island', 'Lagos Mainland', 'Mushin', 'Ojo', 'Oshodi-Isolo', 'Shomolu', 'Surulere', 'Other'] },
    { state: 'Nasarawa', lgas: ['Lafia', 'Other'] },
    { state: 'Niger', lgas: ['Minna', 'Other'] },
    { state: 'Ogun', lgas: ['Abeokuta', 'Ijebu Ode', 'Sango Ota', 'Other'] },
    { state: 'Ondo', lgas: ['Akure', 'Ondo', 'Other'] },
    { state: 'Osun', lgas: ['Osogbo', 'Ile Ife', 'Other'] },
    { state: 'Oyo', lgas: ['Ibadan', 'Ogbomosho', 'Other'] },
    { state: 'Plateau', lgas: ['Jos', 'Other'] },
    { state: 'Rivers', lgas: ['Port Harcourt', 'Obio-Akpor', 'Bonny', 'Other'] },
    { state: 'Sokoto', lgas: ['Sokoto', 'Other'] },
    { state: 'Taraba', lgas: ['Jalingo', 'Other'] },
    { state: 'Yobe', lgas: ['Damaturu', 'Other'] },
    { state: 'Zamfara', lgas: ['Gusau', 'Other'] }
];